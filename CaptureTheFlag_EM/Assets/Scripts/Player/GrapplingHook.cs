...
public class GrapplingHook : NetworkBehaviour
{
    ...
    {
        //Actualiza el jugador en funcion de si esta Hooked o no
    ...
    {
        //Si saltas se desHookea el jugador
        RemoveRopeClientRpc();
        rope.enabled = false;
        ropeRenderer.enabled = false;
    }
    ...
    {
        //Metodo del lanzamiento del gancho
    ...
    {
        //Metodo del balanceo del player
        if (player.State.Value == PlayerState.Hooked)
        {
